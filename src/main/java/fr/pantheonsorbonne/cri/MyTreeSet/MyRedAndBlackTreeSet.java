...
public class MyRedAndBlackTreeSet {
    ...
    private void repareArbre(Noeud courant) throws MyTreeSetException {
        ...
        // Si le frère est rouge, p et f deviennent noirs, pp devient rouge et on
        // relance l'algo plus haut
        if (f != null && f.isRed()) {
            f.setBlack();
            p.setBlack();
            pp.setRed();
    ...
    public static void main(String[] args) throws MyOutOfBoundsException, MyTreeSetException {
        ...
        for (int i = 1; i <= 10; i++) {
            ...
            fin = (System.currentTimeMillis() - debut) / 10;
